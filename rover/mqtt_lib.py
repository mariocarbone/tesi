...
class MQTTConnection:
    ...
    def send_vehicle_status(self,vehicle_status):
        status_json = json.dumps(vehicle_status)
        self.client.publish(self.topic_auto + "/" + self.vehicle_id + "/status", status_json)
